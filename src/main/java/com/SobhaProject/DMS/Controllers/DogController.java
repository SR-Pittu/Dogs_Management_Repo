package com.SobhaProject.DMS.Controllers;
...
import com.SobhaProject.DMS.Models.Dog;
import com.SobhaProject.DMS.Models.Trainer;
import com.SobhaProject.DMS.repository.DogRepository;
import com.SobhaProject.DMS.repository.TrainerRepository;
...
//		}
//		return home();
//		List<Dog> dogList = dogRepo.findByName(dog.getName());
//		for(Dog d: dogList) {
//			dogRepo.delete(d);
//		}
//		return home();
